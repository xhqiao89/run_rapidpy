...
if __name__ == "__main__":
    run_lsm_rapid_process(
        ...
        lsm_data_location='/home/sherry/Downloads/ecmwf/data/temp_era', #path to folder with LSM data
        simulation_start_datetime=datetime(2014, 4, 1),
        simulation_end_datetime=datetime(2014, 4, 30),
